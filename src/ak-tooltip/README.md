The Tooltip Component is an image component for showing a logo or other product information.

## Analysis

The React implementation is little more than pre-defined a collection of breakpoints for setting the
width and height of the tooltip, and set the width and height of the container. The image itself is
