...
Patternfly 5 Groups. Of those 86 components, _52_ have "exceptions to Dark Mode" blocks, places
...
/* ak-content-header */
:root {
    --ak-v1-c-content-header__subtitle--LineHeight: var(
        --ak-v1-global--LineHeight--sm,
...
_Inside the component_, however, we have a different story:
